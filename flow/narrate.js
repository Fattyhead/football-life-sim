...
export function narrateSeason(S, log, ri) {
  ...
  if (c.unlockedMastery?.length) {
    const MASTERY_LINE = {
      勤奮: `年復一年泡在訓練場上，教練都說，很少看過這麼拚的球員——媒體開始叫你「勤奮」。`,
      特訓狂人: `除了訓練還是訓練，場外的你幾乎是個謎——大家給你封了個稱號：「特訓狂人」。`,
      人脈玩家: `轉會市場上，大家都知道找你打聽消息準沒錯——你成了圈內公認的「人脈玩家」。`,
      精算人生: `每一步都算得很精，合約、轉會、退路，你從沒讓自己陷入被動——「精算人生」這個稱號，實至名歸。`,
      萬人迷: `不管走到哪裡都有人認得你、想跟你合照——「萬人迷」這個稱號，你當之無愧。`,
      花天酒地: `派對、豪宅、鎂光燈，你的生活比賽場上的新聞還多——媒體給你貼上了「花天酒地」的標籤。`,
    };
